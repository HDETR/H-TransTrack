...
if __name__ == '__main__':
    data_root = '/mnt/haojun/itpsea4data/Deformable_DETR_MOT/mot20/test'
    txt_path = '/mnt/haojun/itpsea4data/Deformable_DETR_MOT/outputs/two_stage_pretrain_crowdhuman04_train_mix20_multi_gt_query_1500_repeat_5_gpu_8_bs_16_dropout_0_look_forward_twice_sep_attn_sep_loss_multi_loss_weight_04/test'
    save_path = '/mnt/haojun/itpsea4data/Deformable_DETR_MOT/outputs/two_stage_pretrain_crowdhuman04_train_mix20_multi_gt_query_1500_repeat_5_gpu_8_bs_16_dropout_0_look_forward_twice_sep_attn_sep_loss_multi_loss_weight_04/test_dti'
