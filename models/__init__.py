...
from .deformable_detrtrack_train_hybrid_branch import build as build_tracktrain_hybrid_branch
...
def build_tracktrain_model_hybrid_branch(args):
    return build_tracktrain_hybrid_branch(args)