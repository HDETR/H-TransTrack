...
class DeformableTransformer(nn.Module):
    def __init__(self, d_model=256, nhead=8,
        ...
        self.decoder_track = DeformableTransformerDecoder(decoder_layer, num_decoder_layers, return_intermediate_dec, look_forward_twice)
    ...
    def forward(self, srcs, masks, pos_embeds, query_embed=None, pre_reference=None, pre_tgt=None, memory=None, self_attn_mask=None):
        ...
        if pre_reference is not None:
            ...
            hs, inter_references = self.decoder_track(tgt, reference_points, memory,
                                                      spatial_shapes, valid_ratios, query_embed, mask_flatten, self_attn_mask=self_attn_mask)
...
class DeformableTransformerDecoderLayer(nn.Module):
    ...
    def forward(self, tgt, query_pos, reference_points, src, src_spatial_shapes, src_padding_mask=None, self_attn_mask=None):
        # self attention
...
class DeformableTransformerDecoder(nn.Module):
    ...
    def forward(self, tgt, reference_points, src, src_spatial_shapes, src_valid_ratios,
        ...
        for lid, layer in enumerate(self.layers):
            ...
            output = layer(output, query_pos, reference_points_input, src, src_spatial_shapes, src_padding_mask, self_attn_mask)
